...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cephalix/institutes/details/synced-objects').then(m => m.SyncedObjects)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cephalix/institutes/lists').then(m => m.Lists)
  },
  {
    path: 'protected/cephalix/institutes/lists'
    loadComponent: () => import('./protected/cephalix/institutes/lists/institutes-lists.page').then(m => m.InstitutesListsPage)
  },
  {
    path: 'protected/cephalix/institutes/lists'
    loadComponent: () => import('./protected/cephalix/institutes/lists/institutes-status.component').then(m => m.InstitutesStatusComponent)
  },
  {
    path: 'protected/cephalix/institutes/lists'
    loadComponent: () => import('./protected/cephalix/institutes/lists/institutes-sync-objects.component').then(m => m.InstitutesSyncObjectsComponent)
  },
  {
    path: 'protected/cephalix/institutes/lists'
    loadComponent: () => import('./protected/cephalix/institutes/lists/institutes.component').then(m => m.InstitutesComponent)
  },
  {
    path: 'protected/cephalix/institutes/lists'
    loadComponent: () => import('./protected/cephalix/institutes/lists/institutes.manage').then(m => m.InstitutesManage)
  },
  {
    path: 'protected/cephalix'
    loadComponent: () => import('./protected/cephalix/tickets').then(m => m.Tickets)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cranix/devices/lists').then(m => m.Lists)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cranix/rooms/lists').then(m => m.Lists)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cranix/softwares/sets').then(m => m.Sets)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/cranix/users/lists').then(m => m.Lists)
  },
  {
    path: 'protected/cranix/users/lists'
    loadComponent: () => import('./protected/cranix/users/lists/users-2fa').then(m => m.Users2fa)
  },
  {
    path: 'protected/cranix/users/lists'
  ...
  },
  {
    ...
    loadComponent: () => import('./protected/edu/lessons/tests').then(m => m.Tests)
  },
  {
  ...
  {
    path: 'protected/toolbar'
    loadComponent: () => import('./protected/toolbar/toolbar.component').then(m => m.ToolbarComponent)
  },
  {
    path: 'protected'
